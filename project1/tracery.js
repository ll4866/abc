...
/* ------ ADDED SECTION TO WORK WITH SERVER ------ */
    // ADD CUSTOM STRING MODIFIERS
    // LOOP THROUGH INPUT KEYS
    Grammar.prototype.addModifiers = function(obj) {
        for (var k in obj) {
            // ENSURES USE OF OBJECT'S OWN PROPERTY,
            // NOT INHERITED ONES
            if (obj.hasOwnProperty(k)) this.modifiers[k] = obj[k];
        }
    };
    
    // DEFINES A STANDARD SET OF MODIFIERS
